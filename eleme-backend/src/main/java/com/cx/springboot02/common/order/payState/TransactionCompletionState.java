 ...
 */
@Data
public class TransactionCompletionState implements State {
    @Override
    public Boolean doAction(Context context) {
        ...
        order.setArrivalTime(DateUtils.getCurrentTime());
        QueryWrapper<Order> queryWrapper = new QueryWrapper<>();
        queryWrapper.eq("order_state",PayState.DISPATCH.getCode());
    ...
    public PayState getPayState() {
        return PayState.TRANSACTION_COMPLETION;
    }
}
