...
@Component
@Slf4j
public class OrderTimeOutProducerSchedule {

    private DefaultMQProducer producer;

    private final String producerGroup = MessageQueueFinal.ORDER_TIMEOUT_PRODUCER_GROUP;

    @Value("${rocketmq.namesrv-addr}")
    private String nameSrvAddr;

    public OrderTimeOutProducerSchedule() {
    ...
    public void defaultMQProducer() {
        ...
        try {
            this.producer.start();
            log.info("{} Producer start",MessageQueueFinal.ORDER_TIMEOUT_TOPIC);
