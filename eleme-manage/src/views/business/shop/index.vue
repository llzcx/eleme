    ...
    <div class="block">
        ...
        <el-table
            ...
            <template slot-scope="props">
              <el-form label-position="left" inline class="demo-table-expand" label-width="120px">
                ...
                <el-form-item label="销售量">
                  <span>{{ props.row.recentOrderNum }}</span>
                </el-form-item>
          ...
          <el-table-column label="操作" width="450">
            <template slot-scope="scope">
              ...
              <el-button
                v-if="scope.row.deactivate==false"
                size="mini"
                type="danger"
                v-permission="['/business/shop/audit']"
              ...
              <el-button
                v-if="scope.row.deactivate==true"
                size="mini"
                type="primary"
                v-permission="['/business/shop/audit']"
      ...
      <el-dialog
        ...
        <span slot="footer" class="dialog-footer">
            <el-button type="danger" @click="handleAuditConfirm(0)">拒绝</el-button>
