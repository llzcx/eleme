        ...
        <el-col :span="12" :offset="4">
          <el-form :model="formData" :rules="rules" ref="formData" label-width="120px" class="demo-formData">
            ...
            <el-form-item label="平台收取费率(%)" prop="description">
              <el-input type="number" v-model="formData.platformRate"></el-input>
            </el-form-item>
            <el-form-item label="店铺特点" style="white-space: nowrap;">
              <span>品牌保证</span>
              <el-switch on-text="" off-text="" v-model="formData.isPremium"></el-switch>
              <span>蜂鸟专送</span>
            ...
            <el-form-item label="起送价" prop="float_minimum_order_amount">
              <el-input-number v-model="formData.floatMinimumOrderAmount" :min="0" :max="100"></el-input-number>
            </el-form-item>
            ...
            <el-form-item label="上传店铺头像">
              <el-upload
                ...
                <img v-if="formData.imagePath" :src="formData.imagePath" class="avatar">
            ...
            <el-form-item label="上传营业执照">
              <el-upload
                ...
                :before-upload="beforeAvatarUpload">
                <img v-if="formData.businessLicenseImage" :src="formData.businessLicenseImage"
                     class="avatar">
                <i v-else class="el-icon-plus avatar-uploader-icon"></i>
              </el-upload>
            </el-form-item>
            ...
            <el-form-item class="button_submit">
              <el-button type="primary" @click="gotologin()">去往登录</el-button>
            </el-form-item>
          </el-form>
        </el-col>
      </el-row>
