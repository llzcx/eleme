  ...
  <div class="app-container">
    ...
    <el-form :model="selectTable">
      ...
      <el-form-item label="详细地址" label-width="120px">
        <!-- <el-input @click="handleSelectPosition()"  v-model="selectTable.address" type="number"></el-input> -->
        <el-autocomplete v-model="queryAddressByKeyString" :fetch-suggestions="querySearchAsync" placeholder="输入查询关键字"
          style="width: 100%;" @select="addressSelect"></el-autocomplete>
      </el-form-item>
      <el-form-item label="当前地址" label-width="120px">
        <el-input disabled="true"	 :value="selectTable.address" ></el-input>
      </el-form-item>
      <el-form-item label="当前坐标" label-width="120px">
        <el-input disabled="true"	 :value="selectTable.longitude +',' + selectTable.latitude" ></el-input>
      </el-form-item>
    ...
    <el-dialog title="选取定位" :visible.sync="selectPosition">
