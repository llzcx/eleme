  ...
  },
  {
    ...
    children: [
...

      {
        ...
        name: 'Mword',
        hidden: true,
        component: () => import('@/views/manager/word/index'),
        meta: { title: '管理词库' }
      }
    ]
  }, 
  //manager
  {
    ...
    children: [
      ...
      // },
      {
        path: 'Mshop',
        name: 'Mshop',
        component: () => import('@/views/manager/shop/index'),
        meta: { title: 'shopMgr' }
      },
      {
        path: 'Mfood',
        name: 'Mfood',
        component: () => import('@/views/manager/food/index'),
        meta: { title: 'foodMgr' }
      },
      {
        path: 'Morder',
        name: 'Morder',
        component: () => import('@/views/manager/order/index'),
        meta: { title: 'orderMgr' }
      },
      {
        path: 'Morderdetail',
        name: 'Morderdetail',
        hidden: true,
        component: () => import('@/views/manager/orderdetail/index'),
        meta: { title: '订单详情' }
      },

      {
        ...
        name: 'Mfood_add',
        hidden: true,
        component: () => import('@/views/manager/food/add.vue'),
        meta: { title: '添加食品' }
      },
...
export const ShopRouterMap = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'message',
        name: 'message',
        component: () => import('@/views/business/message/message'),
        meta: { title: '消息管理' }
      },
      {
        path: 'comment',
